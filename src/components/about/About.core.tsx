                ...
                <Box width="100%" height="auto" margin={{base: "50px 0 0", smd: "25px 0 0", lg: "50px 0 0"}}
                    ...
                    <Box p="2%" sx={{
                        ...
                        <Box p={{base: "5%", xxxl: "4%"}} sx={{
                            "p:nth-of-type(even)": {fontSize: {base: `10px`, xl: `12px`, xxxl: `14px`}},
                            "p:nth-of-type(odd)": {mb: `0`}
                        }}>
                            ...
                            <p>Buy the NFT, and you can get your specific real bar of gold and another NFT for turning
                                in
                                the NFT through the Claims Process!</p>
                            <br></br>
                            <p>NFT owner's have legal rights to the gold, and can request shipping. Exit to gold!</p>
                            <p>We partner with Lohko Inc and Mattereum to ensure a seamless and legal transition of
                                rights.</p>
                            <p>Matteruem has refined the legal agreement between parties and will act as arbitration in
                                the
                                event of any disputes.</p>
