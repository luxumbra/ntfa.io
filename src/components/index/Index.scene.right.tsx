    ...
    return(
        <Box className={className} as="footer" d="flex" flexDirection="column" flexGrow={1} minW={minW}>
            <AssetContainer width="100%" height="25%" className="logo" parallax="background">
                ...
                <Building buildingName="store" margin="0 0 0 18%" img="/assets/signs/rooftop-martini.png" imgAlt="/assets/signs/rooftop-martini.png" height="20%" width="25%" color="yellow.700" z={0}>
