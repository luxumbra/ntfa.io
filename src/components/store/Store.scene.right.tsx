...
export const StoreSceneRight: FC<StoreSceneRightInterface> = ({ className, minW }) => {
    ...
    return(
        <Box position="relative" className={className} as="footer" flexGrow={1} minW={minW}>
            <Box position="absolute" bottom={{ base: "8%", xl: "50px", xxl: "25%" }} right={{ base: "15px", xl: "20px", xxl: "100px" }} width={{base: "100%", xl: "100px", xxl: "150px"}} height={{base: "auto", xl: "auto"}} className="logo">
