...
function TosCore({ content }: any) {
    ...
    return (
        <Box id="section2" className="ntfa" d="flex" flexDir="row" alignContent="stretch"
            ...
            <Box className="scene__center" flex={{ base: "0 0 90%", smd: "0 0 50%", md: "0 0 66%", xxxl: "0 0 66%" }} ml={["auto", "auto"]} mr={{ base: "auto" }} d="flex" flexDirection="column" alignItems="center" maxH="95vh" zIndex="1000">
