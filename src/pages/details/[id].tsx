...
import { Box, Heading, Text, Link, Button, Image, Stack, HStack } from "@chakra-ui/react";
        ...
        <Box position="absolute" bottom="0" left="0" width="100vw" height={{base: "90px", xxl: "150px", xxxl: "200px"}} zIndex={300}>
            <Box
                ...
                <HStack
                    ...
                    `}>
                    <Box d="inline-flex" alignItems="center">Site from the <span className="heart">🫀</span> of <Link href="#" d="inline-flex" alignItems="center"><Image src="/assets/dps-logo.png" w="20px" h="20px" ml="5px" borderRadius="100%"/></Link></Box>
                </HStack>
            </Box>
        </Box>
    )
